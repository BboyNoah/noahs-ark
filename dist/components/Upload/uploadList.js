...
export var UploadList = function (props) {
    ...
    var generateList = function (list) {
        return list.map(function (item) {
            return (_jsxs("li", __assign({ className: "upload-list-item" }, { children: [_jsxs("span", __assign({ className: "file-name file-name-" + item.status }, { children: [_jsx(Icon, { icon: "file-alt", theme: "secondary" }, void 0), item.name] }), void 0),
    ...
    return (_jsx("ul", __assign({ className: "upload-list" }, { children: generateList(fileList) }), void 0));
};
